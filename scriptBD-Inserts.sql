...
/* ATENDIMENTO */
EXEC ADD_ATEND_AUTOMATICO(1, 'CATEGORIA1', 'SATISFEITO', 130, 'TOPICO1', 'PERGUNTAS1', 'RESPOSTAS1' )
EXEC ADD_ATEND_AUTOMATICO(2, 'CATEGORIA2', 'INSATISFEITO', 131, 'TOPICO2', 'PERGUNTAS2', 'RESPOSTAS2' )
EXEC ADD_ATEND_PERSONALIZADO(3, 'CATEGORIA3', 'MUITO SATISFEITO', 101, 1111, TO_DATE('05/01/2019', 'dd/mm/yyyy'), 'RESUMO_DA_OCORRENCIA', 'DESCRICAO', 40)
EXEC ADD_ATEND_PERSONALIZADO(4, 'CATEGORIA4', 'EXTREMAMENTE SATISFEITO', 102, 2222, TO_DATE('18/07/2019', 'dd/mm/yyyy'), 'RESUMO_DA_OCORRENCIA2', 'DESCRICAO2', 30)
